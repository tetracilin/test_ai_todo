...
const MATERIALIZATION_NOTE =
  "Enabled skills are materialized into the stable Purpose Robot-managed prompt bundle on the agent's next run.";

/** Company skill key of the Purpose Robot core skill that carries beta releases. */
...
export function AgentSkillsTab({ agent, companyId }: { agent: Agent; companyId?: string }) {
  ...
  const unsupportedMessage = useMemo(() => {
    ...
    if (
      ...
      return "Purpose Robot cannot manage skills for custom ACP commands yet.";
    }
    if (agent.adapterType === "openclaw_gateway") {
      return "Purpose Robot cannot manage OpenClaw skills here. Visit your OpenClaw instance to manage this agent's skills.";
    }
    return "Purpose Robot cannot manage skills for this adapter yet. Manage them in the adapter directly.";
