  ...
  const saveRoutine = useMutation({
    ...
    onError: (mutationError) => {
      ...
      pushToast({
        ...
        body: mutationError instanceof Error ? mutationError.message : "Purpose Robot could not save the routine.",
        tone: "error",
      });
    },
  });
  ...
  const runRoutine = useMutation({
    ...
    onError: (runError) => {
      pushToast({
        ...
        body: runError instanceof Error ? runError.message : "Purpose Robot could not start the routine run.",
        tone: "error",
      });
    },
  });
  ...
  const updateRoutineStatus = useMutation({
    ...
    onError: (statusError) => {
      pushToast({
        ...
        body: statusError instanceof Error ? statusError.message : "Purpose Robot could not update the routine.",
        tone: "error",
      });
    },
  });
  ...
  const createTrigger = useMutation({
    ...
    onError: (triggerError) => {
      pushToast({
        ...
        body: triggerError instanceof Error ? triggerError.message : "Purpose Robot could not create the trigger.",
        tone: "error",
      });
    },
  });
  ...
  const updateTrigger = useMutation({
    ...
    onError: (triggerError) => {
      pushToast({
        ...
        body: triggerError instanceof Error ? triggerError.message : "Purpose Robot could not update the trigger.",
        tone: "error",
      });
    },
  });
  ...
  const deleteTrigger = useMutation({
    ...
    onError: (triggerError) => {
      pushToast({
        ...
        body: triggerError instanceof Error ? triggerError.message : "Purpose Robot could not delete the trigger.",
        tone: "error",
      });
    },
  });
  ...
  const rotateTrigger = useMutation({
    ...
    onError: (triggerError) => {
      pushToast({
        ...
        body: triggerError instanceof Error ? triggerError.message : "Purpose Robot could not rotate the webhook secret.",
        tone: "error",
      });
    },
  });
