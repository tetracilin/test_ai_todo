...
function generateReadmeFromSelection(
  ...
  lines.push("```");
  lines.push("");
  lines.push("See [Purpose Robot](https://paperclip.ing) for more information.");
  lines.push("");
  lines.push("---");
  lines.push(`Exported from [Purpose Robot](https://paperclip.ing) on ${new Date().toISOString().split("T")[0]}`);
  lines.push("");
