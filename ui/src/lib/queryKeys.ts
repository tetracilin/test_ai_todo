export const queryKeys = {
  ...
  issues: {
    ...
    externalArtifactObjects: (companyId: string, prefix: string) =>
      ["issues", "external-artifact-objects", companyId, prefix] as const,
    artifactVersions: (companyId: string, artifactId: string) =>
      ["issues", "artifact-versions", companyId, artifactId] as const,
    artifactComments: (companyId: string, artifactId: string) =>
      ["issues", "artifact-comments", companyId, artifactId] as const,
  ...
  projects: {
    ...
    homepage: (id: string) => ["projects", "homepage", id] as const,
  },
  cases: {
  ...
  scheduling: {
    ...
    issue: (companyId: string, issueId: string) =>
      ["scheduling", companyId, "issue", issueId] as const,
    routines: (companyId: string) => ["scheduling", companyId, "routines"] as const,
    routine: (companyId: string, routineId: string) =>
      ["scheduling", companyId, "routines", routineId] as const,
  },
  artifacts: {
    list: (
      companyId: string,
