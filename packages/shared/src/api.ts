...
export const API = {
  ...
  companyWorkQueues: `${API_PREFIX}/companies/:companyId/work-queues`,
  companyWorkQueue: `${API_PREFIX}/companies/:companyId/work-queues/:queueId`,
  companyWorkQueueItems: `${API_PREFIX}/companies/:companyId/work-queues/:queueId/items`,
  companyWorkQueueItemPromote: `${API_PREFIX}/companies/:companyId/work-queues/:queueId/items/:itemId/promote`,
  companyWorkQueueItemDismiss: `${API_PREFIX}/companies/:companyId/work-queues/:queueId/items/:itemId/dismiss`,
