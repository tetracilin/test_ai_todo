...
`;
    ...
    const runner = {
      execute: async (input: {
        ...
        // Managed runtime setup archives the workspace through the sandbox
        // runner. Execute those shell commands against this local fixture too,
        // otherwise the later restore reads an archive that was never created.
