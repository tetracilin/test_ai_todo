...
For this deployment, configure AI agents through `hermes_gateway`. Provider credentials stay in Hermes; Paperclip stores only a secret reference for the gateway credential.
