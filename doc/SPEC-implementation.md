...
- `adapter_type` text; this deployment accepts `hermes_gateway` for AI agents. Legacy compatibility types may remain in imported historical records but are not selectable for new agents.
